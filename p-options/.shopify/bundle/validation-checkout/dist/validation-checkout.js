...
${errorInfo.componentStack}`);
  ...
  function useTranslate() {
    ...
    const translate = (0, import_react16.useCallback)((...args) => {
      const translation = i18n.translate(...args);
      if (!Array.isArray(translation)) {
        return translation;
      }
      return translation.map((part, index) => {
        if (/* @__PURE__ */ (0, import_react16.isValidElement)(part)) {
          return /* @__PURE__ */ (0, import_react16.cloneElement)(part, {
            key: index
          });
        }
        return part;
  ...
  // extensions/validation-checkout/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const ageTarget = 18;
    const [age, setAge] = (0, import_react17.useState)("");
    const [validationError, setValidationError] = (0, import_react17.useState)("");
    const canBlockProgress = useExtensionCapability("block_progress");
    const label = canBlockProgress ? "Age" : "Age(Optional)";
    useBuyerJourneyIntercept((canBlockProgress2) => {
      if (canBlockProgress2 && !isSetAge()) {
        return {
          behavior: "block",
    ...
    if (!instructions.attributes.canUpdateAttributes) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "validation-checkout", status: "warning", children: translate("attributeChangesAreNotSupported") });
    }
    function clearErrorInfo() {
      setValidationError("");
    }
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { border: "dotted", padding: "tight", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "validation-checkout", children: translate("welcome", {
...
//# sourceMappingURL=validation-checkout.js.map
